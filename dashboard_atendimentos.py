...
# ABAS
# ══════════════════════════════════════════════
aba_reg, aba_graf, aba_at, aba_alertas, aba_exp = st.tabs(["📄 Registros", "📊 Gráficos", "👥 Atendentes", "🚨 Alertas", "📥 Exportar"])
